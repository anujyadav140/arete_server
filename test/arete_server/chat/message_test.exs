defmodule AreteServer.Chat.MessageTest do
  use AreteServer.DataCase

  alias AreteServer.Chat.Message

  describe "messages" do
    alias AreteServer.Chat.Message.Message

    import AreteServer.Chat.MessageFixtures
